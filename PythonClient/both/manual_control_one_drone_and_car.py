...
# Use below in settings.json with Blocks environment for example
"""
{
    "SettingsVersion": 1.2,
    "SimMode": "Both",
...
"""
ue_client_ip = "127.0.0.1"  # 切换为开启ue(airsim)实例的本机IP，需要保证运行脚本的机器可以访问这个ip

# connect to the AirSim simulator
client_1 = airsim.MultirotorClient(ip = ue_client_ip, port=41451)
client_1.confirmConnection()
client_1.enableApiControl(True, "Drone1")
client_1.armDisarm(True, "Drone1")

client_2 = airsim.CarClient(ip = ue_client_ip, port=41452)
